...
| [bskyr](https://christophertkenny.com/bskyr/)              | Use the [Bluesky Social HTTP API (XRPC)](https://atproto.com/specs/xrpc) in R | ![Static Badge](https://img.shields.io/badge/lifecycle-mostly_stable-aquamarine) |
